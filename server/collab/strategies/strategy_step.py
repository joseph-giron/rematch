...
class BinningStrategyStep(StrategyStep):
  ...
  def get_source_filters(self):
    return self.get_source_filters() & Q(instance__size__gte=self.min_size,
                                         instance__size__lte=self.max_size)

  def get_target_filters(self):
    return self.get_target_filters() & Q(instance__size__gte=self.min_size,
                                         instance__size__lte=self.max_size)
